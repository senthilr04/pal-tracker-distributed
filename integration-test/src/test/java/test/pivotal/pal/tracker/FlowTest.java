...
public class FlowTest {
    ...
    private ApplicationServer allocationsServer = new ApplicationServer(workingDir + "/../applications/allocations-server/build/libs/allocations-server.jar", "8895");
    ...
    private String allocationsServerUrl(String path) {
        return "http://localhost:8895" + path;
    }
    ...
    public void setup() throws Exception {
        ...
        ApplicationServer.waitOnPorts("8895", "8882", "8883", "8884");
