...
public class FlowTest {
    ...
    private ApplicationServer allocationsServer = new ApplicationServer(workingDir + "/../applications/allocations-server/build/libs/allocations-server.jar", "8981");
    ...
    private String allocationsServerUrl(String path) {
        return "http://localhost:8981" + path;
    }
    ...
    public void setup() throws Exception {
        ...
        ApplicationServer.waitOnPorts("8981", "8882", "8883", "8884");
