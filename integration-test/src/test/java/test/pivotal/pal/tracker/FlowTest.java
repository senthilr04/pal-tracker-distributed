...
public class FlowTest {
    ...
    private ApplicationServer allocationsServer = new ApplicationServer(workingDir + "/../applications/allocations-server/build/libs/allocations-server.jar", "7981");
    ...
    private String allocationsServerUrl(String path) {
        return "http://localhost:7981" + path;
    }
    ...
    public void setup() throws Exception {
        ...
        ApplicationServer.waitOnPorts("7981", "8882", "8883", "8884");
